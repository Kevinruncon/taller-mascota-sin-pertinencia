...
//    }
//
//    public boolean registrarConsulta(String codigo, String fecha, Veterinario veterinario, String documentoPropCons, String nombreMasCons,String diagnostico,String tratamiento, int idMas) {
...
//           ||tratamiento.isBlank() || diagnostico == null || diagnostico.isBlank() || idMas <=0) {
//            return false;
//        }
...
//        Consulta c = new Consulta(codigo, fecha, veterinario, documentoPropCons, nombreMasCons, diagnostico, tratamiento,idMas);
//        
...
//    }
//
//   public boolean editarConsulta(String codigo, String fecha, Veterinario veterinario, String documentoPropCons, String nombreMasCons,String diagnostico,String tratamiento,int idMas) {
//        // Validar que el código y la fecha no estén vacíos
//        if ( documentoPropCons == null||documentoPropCons.isBlank() ||fecha == null || fecha.isBlank() || codigo == null || codigo.isBlank()|| veterinario == null ||tratamiento == null
//           ||tratamiento.isBlank() || diagnostico == null || diagnostico.isBlank() || idMas <= 0) {
//            return false;
...
//
//    try {
//       Consulta nuevaConsulta = new Consulta(codigo, fecha, veterinario, documentoPropCons, nombreMasCons, diagnostico, tratamiento,idMas);
